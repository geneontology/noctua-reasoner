...
Reasoner.prototype.getValidRelations = function(subjects, objects) {
...
Reasoner.prototype.check = function(testClassIds, expectedClassIds) {
    if (!expectedClassIds) {
        return true;
    }
 ...
 */
Reasoner.prototype.og_to_graphlib = function(og, gPred) {
